...
<div id="hienthituyedung" class="container" >
 ...
 <div class="alert alert-danger">
        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
        <i class="glyphicon glyphicon-fire"></i> Tin tuyển dụng <b>lừa đảo </b> sẽ bị xóa không cần báo trước! </div>
      <?= (!kttype(1))?"<div class='alert alert-warning'>Để chỉnh sửa tin tuyển dụng đã đăng, bạn cần đăng nhập trước <i class='glyphicon glyphicon-log-in '></i></div>":"<div class='alert alert-success'>  <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> Có thể thay đổi tất cả thông tin bên dưới cho phù hợp với mỗi tin tuyển dụng mà bạn đăng. Ngoại trừ logo bạn phải vào quản lý thông tin để đổi.</div>" ; ?>
...
<div class="row boxchitiet">
    <div class="tieudetuyendung">THÔNG TIN TUYỂN DỤNG</div>  
          <?php if(isset($_COOKIE['email']) && kttype(1) ){ 
		   $matk=$_COOKIE['email'];
    ...
    <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input id="tieude" maxlength="100" name="vitri"  type="text"  placeholder="Có thể nhập nhiều vị trí cần tuyển vào đây" value=""   class="form-control nhapthongtin" required>
...
<b for=" <?php  echo $r['id_vung']; ?>" class="font14">  <?php  echo $r['tennganh']; ?></b>
</div>
...
<b for=" <?php  echo $r['id_vung']; ?>" class="font14">  <?php  echo $r['tenvung']; ?></b>
    ...
    <div class="tieudetuyendung">THÔNG TIN LIÊN HỆ</div>  
          <?php 
		   ...
		   if(isset($_COOKIE['email']) && kttype(1))
		   {
    ...
    <div class="form-group">
            <label  class="control-label col-sm-2" style="font-size:15px" for="email" > Email: </label>
            <div class="col-sm-8">
              <input name="email" maxlength="100" type="email"  value=""   class="form-control" >
            </div>
  ...
  <?php if(isset($_COOKIE['email']) && kttype(1)){ 
        ?>
      <button title="<?= $_COOKIE['email'] ?>"  class=" btn btn-warning btn-md  btn-mobiquanly" ><i class="glyphicon glyphicon-user"></i></button>
...
<div id="quanlynhatuyendung" class="login">	
 ...
 <div class="boxdangky">
<h3 class="blue">Nhà tuyển dụng chưa có tài khoản?</h3>
  Nhấn vào đây<a href="nha-tuyen-dung-dang-ky.html">
      <span class="glyphicon glyphicon-plus-sign"></span> <b>Đăng Ký</b></a>  <br>
                      </div>
        <div class="boxdangky">
...
<script type="text/javascript">CKEDITOR.replace('ghichu');
