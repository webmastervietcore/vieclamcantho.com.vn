...
$sql = "SELECT count(*) as row FROM tuyendung,vungtuyendung where tuyendung.matuyendung=vungtuyendung.matuyendung and mavung=:mavung and now()<=ngayhethan";

$row=select($sql,array("mavung"=>$mavung),$db);
$row=$row[0];
...
$stmt=  select($sql,array("mavung"=>$mavung),$db);
...
<span class="glyphicon glyphicon-plus"></span>Cộng trang chủ <div class="g-plusone" data-size="standard"  ></div>
        ...
        <div id="anhthi"  style="position: absolute;z-index: -1">
            <div id="vietcore"> <a  href="http://thietkewebcantho.net"  target="_blank"><image  class="img-responsive"  src='quangcao/vietcore1.gif'></a></div>
